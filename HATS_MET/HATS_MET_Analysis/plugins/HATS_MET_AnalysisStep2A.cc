// -*- C++ -*-
//
// Package:    HATS_MET/HATS_MET_AnalysisStep2A
// Class:      HATS_MET_AnalysisStep2A
// 
/**\class HATS_MET_AnalysisStep2A HATS_MET_AnalysisStep2A.cc HATS_MET/HATS_MET_Analysis/plugins/HATS_MET_AnalysisStep2A.cc
...
class HATS_MET_AnalysisStep2A : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit HATS_MET_AnalysisStep2A(const edm::ParameterSet&);
      ~HATS_MET_AnalysisStep2A();
...
//
HATS_MET_AnalysisStep2A::HATS_MET_AnalysisStep2A(const edm::ParameterSet& iConfig):
...
HATS_MET_AnalysisStep2A::~HATS_MET_AnalysisStep2A()
{
...
void
HATS_MET_AnalysisStep2A::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
void 
HATS_MET_AnalysisStep2A::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
HATS_MET_AnalysisStep2A::endJob() 
{
  //  file->cd();
  //tree->Write();
  //  file->Write();
...
void
HATS_MET_AnalysisStep2A::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(HATS_MET_AnalysisStep2A);
