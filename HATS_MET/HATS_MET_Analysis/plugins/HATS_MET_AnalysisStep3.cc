// -*- C++ -*-
//
// Package:    HATS_MET/HATS_MET_Analysis
// Class:      HATS_MET_AnalysisStep3
// 
/**\class HATS_MET_Analysis HATS_MET_AnalysisStep3.cc HATS_MET/HATS_MET_Analysis/plugins/HATS_MET_AnalysisStep3.cc
...
class HATS_MET_AnalysisStep3 : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit HATS_MET_AnalysisStep3(const edm::ParameterSet&);
      ~HATS_MET_AnalysisStep3();
  ...
  //  TFile *file = new TFile("/uscms_data/d3/loukas/das2019/METAndPU/lgtests/CMSSW_9_4_12/src/outputs/metandpu_step3.root","recreate");
...
//
HATS_MET_AnalysisStep3::HATS_MET_AnalysisStep3(const edm::ParameterSet& iConfig):
...
HATS_MET_AnalysisStep3::~HATS_MET_AnalysisStep3()
{
...
void
HATS_MET_AnalysisStep3::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
void 
HATS_MET_AnalysisStep3::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
HATS_MET_AnalysisStep3::endJob() 
{
  //  file->cd();
  //  tree->Write();
  //  file->Write();
...
void
HATS_MET_AnalysisStep3::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(HATS_MET_AnalysisStep3);
