// -*- C++ -*-
//
// Package:    HATS_MET/HATS_MET
// Class:      HATS_MET
// 
/**\class HATS_MET HATS_MET.cc HATS_MET/HATS_MET/plugins/HATS_MET.cc
...
class HATS_MET : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit HATS_MET(const edm::ParameterSet&);
      ~HATS_MET();
...
//
HATS_MET::HATS_MET(const edm::ParameterSet& iConfig):
...
void
HATS_MET::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
void
HATS_MET::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
